...
const TIPS = {
  ...
  casterGain: 'Dynamic camber change caused by caster angle as the wheel turns into the corner. More caster = more negative camber gain on the outside front (RF) during cornering — free grip.',
  effectiveCamber: 'The actual camber angle at mid-corner: static setting plus caster-induced dynamic camber. This is what the tire "sees" during the hardest part of the corner.',
  idealCamber: {
    outside: 'Model target for the outside front (RF) at 1G: −3.0°. The outside tire carries most of the cornering load and needs negative camber to stay flat under body roll.',
    inside: 'Model target for the inside front (LF) at 1G: +0.6°. The inside tire is lightly loaded; slight positive camber keeps it in contact with the road.',
