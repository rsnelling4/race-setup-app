...
import { simulateRace, DEFAULT_SETUP, RECOMMENDED_SETUP } from '../utils/raceSimulation';
          ...
          {['LF', 'RF'].map(c => (
            <div key={c} className="sim-input-group">
              ...
              <input
                ...
                onChange={e => updateCamber(c, e.target.value)}
              />
            </div>
          ))}
        </div>
      ...
      <div className="sim-form-section">
        ...
        <div className="sim-input-grid one-col">
          <div className="sim-input-group">
            ...
            <input
              type="number" step="0.0625" min="-1" max="1"
              value={setup.toe}
              onChange={e => updateToe(e.target.value)}
            />
